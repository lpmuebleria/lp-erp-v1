...
def require_superadmin(request: Request):
    ...
    # We use the X-User-ID header that App.jsx sends, but we VALIDATE IT against the database for safety.
    ...
    if user_id:
        ...
        try:
            ...
            if u and (u["is_superadmin"] or u["nombre"] == "Administrador General"):
                # "Heal" the session for this request's scope to satisfy downstream checks if any
